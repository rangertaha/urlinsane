...
// func NewAccumulator(out chan<- *db.Domain, conf internal.Config) internal.Accumulator {
...
// func (ac *accumulator) Add(domain *db.Domain) {
// 	// ac.log.Debug("Passing domain to next")
// 	ac.out <- domain
// }

// func (ac *accumulator) Get() (domain *db.Domain) {
// 	// ac.log.Debug("Passing domain to next")
...
// // func (c *accumulator) Domain() db.Domain {
// // 	return c.domain
// // }
