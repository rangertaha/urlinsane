...
// a hyphen inserted at every gap including the ends.
func TestGeneratesKnownVariants(t *testing.T) {
	got := hi.Spec().Gen("abc")
	want := []string{"-abc", "a-bc", "ab-c", "abc-"}
