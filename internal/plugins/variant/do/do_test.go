...
// each dot removed, and all of them.
func TestGeneratesKnownVariants(t *testing.T) {
	got := do.Spec().Gen("a.b.c")
...
func TestReturnsNoDuplicates(t *testing.T) {
	...
	for _, g := range do.Spec().Gen("a.b.c") {
		if seen[g] {
