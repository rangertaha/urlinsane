...
// dot and hyphen swapped for one another.
func TestGeneratesKnownVariants(t *testing.T) {
	got := dhs.Spec().Gen("a.b-c")
...
func TestReturnsNoDuplicates(t *testing.T) {
	...
	for _, g := range dhs.Spec().Gen("a.b-c") {
		if seen[g] {
