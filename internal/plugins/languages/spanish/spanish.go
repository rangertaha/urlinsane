...
func (l *Spanish) Keyboards() (boards []internal.Keyboard) {
...
var (
	...
	esMisspellings = [][]string{
		...
		// Common misspellings
		{"haber", "haver"},
		{"tubo", "tuvo"},  // also a homophone pair
		{"echo", "hecho"}, // also a homophone pair
	}
	...
	Language = Spanish{
		...
		numerals: map[string][]string{
			...
			"0":             []string{"cero"},
			"1":             []string{"uno", "primero", "primer"},
			"2":             []string{"dos", "segundo"},
			"3":             []string{"tres", "tercero"},
			"4":             []string{"cuatro", "cuarto"},
			"5":             []string{"cinco", "quinto"},
			"6":             []string{"seis", "sexto"},
			"7":             []string{"siete", "séptimo", "septimo"},
			"8":             []string{"ocho", "octavo"},
			"9":             []string{"nueve", "noveno"},
			"10":            []string{"diez", "décimo", "decimo"},
			"11":            []string{"once"},
			"12":            []string{"doce"},
			"13":            []string{"trece"},
			"14":            []string{"catorce"},
			...
			"80":            []string{"ochenta"},
			"90":            []string{"noventa"},
			"100":           []string{"cien", "ciento"},
			"1000":          []string{"mil"},
			"1000000":       []string{"millón", "millon"},
			"1000000000":    []string{"milmillones", "mil millones"},
			"1000000000000": []string{"billón", "billon"},
		},
		graphemes: []string{
			"a", "b", "c", "d", "e", "f", "g",
			"h", "i", "j", "k", "l", "m", "n",
