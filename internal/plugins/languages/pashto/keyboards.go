...
var Keyboards = []Keyboard{
	// A practical Pashto layout (Arabic-based) including key Pashto letters.
	// Note: this is used for adjacency-based typos; it does not need to perfectly
	// mirror every OS keyboard variant to be useful.
	{
		lang:        LANGUAGE,
		code:        "ps1",
		name:        "Pashto",
		description: "Pashto keyboard layout (Arabic-based)",
		layout: []string{
			"۱۲۳۴۵۶۷۸۹۰-  ",
			" ضصثقفغعهخحجڅ",
			"  شسیبلاتنمکګ",
