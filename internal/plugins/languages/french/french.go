...
var (
	...
	frMisspellings = [][]string{
		...
		{"recencement", "recensement"},
		{"rédition", "reddition"},
		{"rédibitoire", "rédhibitoire"},
		{"répis", "répit"},
		{"scénette", "saynète"},
		{"succint", "succinct"},
		{"suffisament", "suffisamment"},
		{"vraissemblance", "vraisemblance"},
