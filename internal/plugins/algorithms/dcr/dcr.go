...
func (n *Algo) Domain(in internal.Typo) (out []internal.Typo) {
	return n.Exec(in)
}

func (n *Algo) Username(in internal.Typo) (out []internal.Typo) {
	return n.Exec(in)
}

func (n *Algo) Emmail(in internal.Typo) (out []internal.Typo) {
	return n.Exec(in)
}

func (n *Algo) Entity(in internal.Typo) (out []internal.Typo) {
	return n.Exec(in)
}
