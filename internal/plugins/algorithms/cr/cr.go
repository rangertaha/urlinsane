...
func (n *Algo) domain(typo internal.Typo) (typos []internal.Typo) {
	...
	for _, variant := range algo.CharacterRepetition(prefix) {
		if prefix != variant {
...
func (n *Algo) email(typo internal.Typo) (typos []internal.Typo) {
	...
	for _, variant := range algo.CharacterRepetition(username) {
		if username != variant {
...
func (n *Algo) name(typo internal.Typo) (typos []internal.Typo) {
	...
	for _, variant := range algo.CharacterRepetition(name) {
		if name != variant {
